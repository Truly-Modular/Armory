...
- changed all armors durability calculation to closer fir vanilla (thanks @pixale) -> materials can now set armor_durability directly, they are multiplied for each module.
